-- WilnBill Database Schema
-- Modern WiFi Billing Management System
-- Updated: 2026-04-08
...
-- WilnBill Default Configuration
INSERT INTO
    `tbl_appconfig` (`id`, `setting`, `value`)
VALUES (1, 'CompanyName', 'WilnBill'), (2, 'currency_code', '$'), (3, 'language', 'english'), (4, 'show-logo', '1'), (5, 'nstyle', 'modern'), (6, 'timezone', 'UTC'), (7, 'dec_point', '.'), (8, 'thousands_sep', ','), (9, 'rtl', '0'), (10, 'address', ''), (11, 'phone', ''), (12, 'date_format', 'd M Y'), (13, 'note', 'Modern WiFi Billing System');
