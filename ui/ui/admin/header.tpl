...
<head>
    ...
    <link rel="shortcut icon" href="{$app_url}/ui/ui/images/logo.svg" type="image/x-icon" />
    ...
    <link rel="stylesheet" href="{$app_url}/ui/ui/styles/wilnbill-modern.css?2026.4.8" />
...
document.addEventListener('click', function(event) {
    ...
    if (!sidebar.contains(event.target) && !toggle.contains(event.target) && overlay.classList.contains('active')) {
        toggleMobileSidebar();
    }
});
