...
class MikrotikHotspot
{
    ...
    function description()
    {
        return [
            ...
            'description' => 'To handle connection between WilnBill with Mikrotik Hotspot',
            'author' => 'wilndotcom',
            'url' => [
                'Github' => 'https://github.com/wilndotcom/wilnbill/',
                'Telegram' => 'https://t.me/wilndotcom',
                'Donate' => 'https://paypal.me/wilndotcom'
            ]
        ];
    }
