 ...
 *
 * This script is for updating WilnBill
 **/
session_start();
include "config.php";
...
// Prevent any update attempts
if (empty($update_url)) {
    r2("./?_route=dashboard", 'e', 'Auto-update is disabled for security reasons');
}
...
$file = pathFixer('system/cache/wilnbill.zip');
$folder = pathFixer('system/cache/wilnbill-' . basename($update_url, ".zip") . '/');
...
<body class="hold-transition skin-blue">
    <div class="container">
                    ...
                    <?php if ($continue || $step == 5) { ?>
                        ...
                        <?php } else if ($step == 5) { ?>
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    WilnBill has been updated to Version <b><?= $version ?></b>
                                </div>
                            </div>
        ...
        <footer class="footer text-center">
            WilnBill by <a href="https://github.com/wilndotcom/wilnbill" rel="nofollow noreferrer noopener" target="_blank">wilndotcom</a>
        </footer>
    </div>
</body>
